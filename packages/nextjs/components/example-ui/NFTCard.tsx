...
export const NFTCard = ({ tokenId }: NFTCardProps) => {
  ...
  // Check if marketplace is approved (only if marketplace is deployed)
      ...
      <div className="card bg-base-100 shadow-xl">
        ...
        <div className="card-body">
              ...
              <div className="stat p-4">
                ...
                {ethPriceUSD > 0 && (
                  <div className="stat-desc">
                    {isLoadingPrice ? "Loading..." : `~$${priceInUSD} USD`}
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="card-actions justify-end mt-4">
            ...
            {marketplaceAddress && !isOwner && isListed && (
            ...
            {marketplaceAddress && isOwner && !isListed && isApproving && (
